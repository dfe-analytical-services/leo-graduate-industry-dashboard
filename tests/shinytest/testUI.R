...
app$snapshot(items=list(input=industryFlow_input,
...
industryBySubject_input <- c("navbar","countinput3","YAGinput3","qualinput4",
                             "sectionnameinput2")
...
app$snapshot(items=list(input=industryBySubject_input,
...
app$snapshot(items=list(input=regional_input,
